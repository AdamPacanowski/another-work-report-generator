...
test('simple parsing (equal method)', () => {
  const rawCommits = [
    {
      'gitFolder':'C:\\Users\\XXX\\AppData\\Local\\Temp\\testStubGitRepo\\repo1\\.git',
      'commits':[
  ...
  const calculatedCommits = commitsParser.equalCalculation(rawCommits, settings);
...
test('simple parsing (equal method) with small commit', () => {
  const rawCommits = [
    {
      'gitFolder':'C:\\Users\\XXX\\AppData\\Local\\Temp\\testStubGitRepo\\repo1\\.git',
      'commits':[
        ...
        '7066af8f9125b85f41b014453802b2f1c488f7d2;7066af8;1483354800;test-commit-2\n 1 file changed, 50 deletions(-)',
        '3d14b278e7e68d4d775cf363021e02f7eb88551f;3d14b27;1483275600;test-commit-1\n 1 file changed, 90 insertions(+)',
        '8f9125b85f418e7e68d4d26964df1021e02f7eb8;8f9125b;1483275601;test-commit-4\n 1 file changed, 1 insertions(+)',
        'fb1eb3ead0e20fed1029bea0edd7626964df326b;fb1eb3e;1483268400;test-commit-0\n 1 file changed, 10 insertions(+)'
      ]
    }
  ];
  ...
  expect(
    _.find(calculatedCommits.commits, {hash: '8f9125b'}).project
  ).toBe('repo1');
  expect(
    _.find(calculatedCommits.commits, {hash: '8f9125b'}).lines
  ).toBe(1);
  expect(
    _.find(calculatedCommits.commits, {hash: '8f9125b'}).time
  ).toBe(0.1);
  ...
  expect(calculatedCommits.commitsLengthMap['2017-01-01']).toBe(3);
  expect(calculatedCommits.commitsLengthMap['2017-01-02']).toBe(1);
  expect(calculatedCommits.commitsLengthMap['2017-01-03']).toBe(1);
});
